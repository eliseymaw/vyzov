      ...
      <div className="max-w-2xl">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {favorites.size > 0 && (
              <a href="/favorites" className="rounded-xl border border-yellow-800 bg-yellow-950 px-3 py-1.5 text-sm text-yellow-400">
                ★ {favorites.size}
              </a>
            )}
            {ignored.size > 0 && (
              <a href="/ignored" className="rounded-xl border border-zinc-700 bg-zinc-900 px-3 py-1.5 text-sm text-zinc-500 hover:text-white">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className={`rounded-lg p-1.5 text-sm transition-colors ${
                        favorites.has(ad.id) ? "text-yellow-400" : "text-zinc-600 hover:text-yellow-400"
                      }`}
                    >
                      ★
                    </button>
